...
class OpportunistcApp2(Application):
    def __init__(self,
    ...
    def get_qc(self, src: QNode, dest: QNode) -> QuantumChannel:
        apps = src.get_apps(OpportunistcApp2)
        app = apps[0]
...
def exp3(islog: bool = False, isopp: bool = False,
    ...
    if islog:
        ...
        log.install(s)
    drop_rate = 0.0
    topo2 = GridTopology(nodes_number=M**2, nodes_apps=[OpportunistcApp2(p_gen=p_gen, p_swap=p_swap, lifetime=L, isopp=isopp)],
