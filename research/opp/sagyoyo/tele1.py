...
def hadmard(qubit: Qubit):
    H(qubit=qubit)

def controllednot(q1: Qubit, q2: Qubit):
    CNOT(qubit1=q1, qubit2=q2)
...
h1 = QuantumOperator(name="h1", node=n2, gate=hadmard)
h2 = QuantumOperator(name="h2", node=n1, gate=hadmard)

c1 = QuantumOperator(name="c1", node=n3, gate=controllednot)
c2 = QuantumOperator(name="c2", node=n2, gate=controllednot)
